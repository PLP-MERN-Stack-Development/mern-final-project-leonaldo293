                ...
                <div className="text-center space-y-4 p-8">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-pretty max-w-md">
                      An interactive map showing donations near you would be displayed here. In production, we would integrate with Google Maps, Mapbox, or Leaflet.
                    </p>
                  </div>
                  {userLocation && (
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <Button asChild className="w-full">
                        <Link href={`/doacoes/${selectedDonation.id}`}>View Details</Link>
                      </Button>
                    </CardContent>
                  </Card>
                </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {sortedDonations.length} donations available in your area
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="vegetais">Vegetables</SelectItem>
                      <SelectItem value="graos">Grains</SelectItem>
                      <SelectItem value="laticinios">Dairy</SelectItem>
                      <SelectItem value="proteinas">Proteins</SelectItem>
                      <SelectItem value="padaria">Bakery</SelectItem>
